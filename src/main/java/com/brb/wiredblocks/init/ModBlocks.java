...
public class ModBlocks {
	 public static final Block OAK_WIRED_LOG = register("wired_oak_log", new WiredBlock(MaterialColor.WOOD, Block.Properties.create(Material.WOOD, MaterialColor.OBSIDIAN).hardnessAndResistance(2.0F).sound(SoundType.WOOD)));
	 public static final Block BIRCH_WIRED_LOG = register("wired_birch_log", new WiredBlock(MaterialColor.SAND, Block.Properties.create(Material.WOOD, MaterialColor.QUARTZ).hardnessAndResistance(2.0F).sound(SoundType.WOOD)));
	 public static final Block ACACIA_WIRED_LOG = register("wired_acacia_log", new WiredBlock(MaterialColor.ADOBE, Block.Properties.create(Material.WOOD, MaterialColor.STONE).hardnessAndResistance(2.0F).sound(SoundType.WOOD)));
	 public static final Block JUNGLE_WIRED_LOG = register("wired_jungle_log", new WiredBlock(MaterialColor.DIRT, Block.Properties.create(Material.WOOD, MaterialColor.OBSIDIAN).hardnessAndResistance(2.0F).sound(SoundType.WOOD)));
	 public static final Block SPRUCE_WIRED_LOG = register("wired_spruce_log", new WiredBlock(MaterialColor.OBSIDIAN, Block.Properties.create(Material.WOOD, MaterialColor.BROWN).hardnessAndResistance(2.0F).sound(SoundType.WOOD)));
	 public static final Block DARK_OAK_WIRED_LOG = register("wired_dark_oak_log", new WiredBlock(MaterialColor.BROWN, Block.Properties.create(Material.WOOD, MaterialColor.BROWN).hardnessAndResistance(2.0F).sound(SoundType.WOOD)));
